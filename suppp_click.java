...
// https://kprlogin.cloud.testinsights.io/app/#!/module-collection/guid/c56de675-79a9-4fa1-932e-5d41a409cc21
@TestModellerModule(guid = "c56de675-79a9-4fa1-932e-5d41a409cc21")
public class suppp_click extends BasePage
{
	public suppp_click (WebDriver driver)
	{
		super(driver);
	}
	...
	private WebIdentifier Supplier_accountElem = new WebIdentifier(By.xpath("/html/body/form/div[2]/div[1]/div/div/div/div[1]/div[3]/div[1]/div/div[1]/div[2]/div/div[1]/div/div/div/div/div/div/input"), 100049l);;
