...
// https://kprlogin.cloud.testinsights.io/app/#!/module-collection/guid/3c6a1de3-5313-44cc-8e34-477a7c3c0a3a
@TestModellerModule(guid = "3c6a1de3-5313-44cc-8e34-477a7c3c0a3a")
public class purchase_new extends BasePage
{
	public purchase_new (WebDriver driver)
	{
		super(driver);
	}
	...
	private WebIdentifier AltN_NewElem = new WebIdentifier(By.xpath("//label[normalize-space()= 'Search for an action']/../../../div[4]/button[1]"), 100037l);;
