...
// https://kprlogin.cloud.testinsights.io/app/#!/module-collection/guid/c0b6e17c-abad-40a1-9626-2fbafb9f2570
@TestModellerModule(guid = "c0b6e17c-abad-40a1-9626-2fbafb9f2570")
public class New_Radio_Name extends BasePage
{
	public New_Radio_Name (WebDriver driver)
	{
		super(driver);
	}
	...
	private WebIdentifier UnknownElem = new WebIdentifier(By.xpath("//label[normalize-space()= 'One-time supplier']/../div/span[1]"), 100039l);;

	private WebIdentifier PurchTable_OrderAccountElem = new WebIdentifier(By.xpath("//label[normalize-space()= 'Supplier account']/../input"), 100040l);;
