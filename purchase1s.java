...
// https://kprlogin.cloud.testinsights.io/app/#!/module-collection/guid/c2a074a2-6929-4e46-bab8-2dfff5c0305c
@TestModellerModule(guid = "c2a074a2-6929-4e46-bab8-2dfff5c0305c")
public class purchase1s extends BasePage
{
	public purchase1s (WebDriver driver)
	{
		super(driver);
	}
	...
	private WebIdentifier Purchase_orderElem = new WebIdentifier(By.xpath("/html/body/div[2]/div/div[6]/div/form/div[5]/div/div[3]/div[2]/div[1]/div[4]/div/div[2]/div/div/div/div[1]/div[3]/div[7]/div/div[1]/div[2]/div/div[1]/div/div/div/div/div/div/input"), 100073l);;
